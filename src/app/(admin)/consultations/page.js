      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">
            Ayurvedic Expert Consultations
          </h1>
        ...
        <div className="bg-white p-12 rounded-xl border border-gray-100 shadow-sm text-center">
          ...
          <p className="text-gray-500 text-sm">
            {searchTerm
              ...
              : "Any patient consultation requests will appear here."}
          </p>
        </div>
      ) : (
              ...
              <tbody className="divide-y divide-gray-100 text-sm text-gray-700">
                {filteredConsultations.map((item) => (
                  <tr key={item._id} className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="px-6 py-4">
                      <p
                        className="truncate max-w-[240px] text-gray-500"
                        title={item.problem}
                      >
                        {item.problem}
                      </p>
            ...
            <div className="bg-blue-600 text-white p-5 flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-blue-100 mt-0.5">
                  Submitted on {formatDate(selectedConsult.createdAt)}
                </p>
              </div>
              <button
            ...
            <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <div className="col-span-2 border-t border-gray-200/50 pt-2.5 mt-1">
                  ...
                  <a
                    href={`mailto:${selectedConsult.email}`}
