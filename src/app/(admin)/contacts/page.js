      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            View and manage customer queries submitted through the Contact Us
            form
          </p>
        </div>
        ...
        <div className="bg-white p-12 rounded-xl border border-gray-100 shadow-sm text-center">
          ...
          <p className="text-gray-500 text-sm">
            {searchTerm
              ...
              : "Any customer inquiries will appear here."}
          </p>
        </div>
      ) : (
              ...
              <tbody className="divide-y divide-gray-100 text-sm text-gray-700">
                {filteredContacts.map((item) => (
                  <tr key={item._id} className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-0.5 text-xs text-gray-500">
                        <span className="flex items-center gap-1.5 text-sm text-gray-800 font-medium">
                          <FaPhoneAlt className="text-amber-600 text-[10px]" />{" "}
                          {item.mobile}
                        </span>
                    ...
                    <td className="px-6 py-4">
                      <p
                        className="font-medium text-gray-800 max-w-[200px] truncate"
                        title={item.subject}
                      >
                        {item.subject}
                      </p>
                    ...
                    <td className="px-6 py-4">
                      <p
                        className="truncate max-w-[280px] text-gray-500"
                        title={item.message}
                      >
                        {item.message}
                      </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-100 animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              {/* Subject */}
              <div>
                <span className="text-xs font-bold text-gray-500 uppercase block tracking-wider mb-1">
                  Subject
                </span>
