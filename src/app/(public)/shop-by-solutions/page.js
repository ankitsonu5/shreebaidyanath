...
export default function ShopBySolutions() {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get(`${API}/shop-by-solutions`);
      const data = res.data;
      if (data.success) {
                      ...
                      {product.productStock > 0 ? (
                        <>
                          ...
                          <button
                            ...
                            className="mt-auto w-full bg-amber-600 hover:bg-amber-700 text-white text-sm font-semibold py-2 rounded-md transition-colors cursor-pointer shadow-sm"
                          >
                            Add to Cart
                          </button>
                        </>
                        ...
                        <button
                          disabled
                          className="mt-auto w-full bg-gray-200 text-gray-400 text-sm font-semibold py-2 rounded-md cursor-not-allowed"
                        >
                          Out of Stock
                        </button>
                      )}
